...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="text-align: right">
            ...
            <div class="col-11" style="background-color: rgba(255, 255, 255, 1); margin-top: 49px; height: 140px; border-radius: 70px 0 0 70px">
               <div class="row">
                   ...
                   <div class="col-9" style="text-align: center; padding-left: 30px">
                      ...
                      <div style="text-align: right; float: left; width: 100px; font-size: 12px; padding-bottom: 20px; padding-top: 10px"><a>опилкобетонные</a><br><a>пескоцементные</a></div><br>
   ...
   <div class="container-fluid">
       <div class="row">
           <div class="col-12" style="padding-top: 20px; align-content: center; text-align: center">
               ...
               <div style="text-align: left; width: 325px; height: 68px; top: 0; right: 0; bottom: 0; left: 0; margin:auto"><a style="font-size: 14px">Связываетесь с нашей компанией по<br> телефону 89113415444 или оставьте свои<br> контактные данные что бы менеджер смог с Вами связаться.</a></div>
